  ...
  return (
    <div className="container flex flex-col gap-6 py-8">
      <div className="flex flex-col gap-2">
        <h1 className="section-title">Text-to-Audio (T2A)</h1>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <div className="md:col-span-2">
          <Card>
            <CardHeader>
              <CardTitle>Create Audio from Text</CardTitle>
              <CardDescription>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  placeholder="Enter the text you want to convert to speech. Example: 'Typing on a keyboard' or 'A person speaking with excitement about a new product launch.'"
                />
              </div>
              ...
              {audioGenerated && (
                <div className="space-y-2 mt-4">
                  ...
                  <div className="bg-muted rounded-md p-3 flex items-center justify-between">
                    ...
                    <div className="w-full max-w-[70%] bg-secondary rounded-full h-1.5">
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground">
            Access our Text-to-Audio service through our API.
